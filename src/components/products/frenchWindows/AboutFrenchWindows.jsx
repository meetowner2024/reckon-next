...
import { CheckCircle, Cog, Home, ArrowRight, ShieldCheck, Layers } from "lucide-react";
...
const AboutFrenchWindows = () => {
  ...
  const ActiveIcon = features[active]?.Icon || CheckCircle;

  return (
    <section
      aria-labelledby="about-french-heading"
        ...
        <div className="mb-10 grid gap-8 lg:grid-cols-12 items-center">
          ...
          <div className="lg:col-span-7">
            ...
            <FadeUp delay={160}>
              ...
              >
                Reckon French Windows
              </h2>
            </FadeUp>

            <FadeUp delay={240}>
              <p className="mt-4 text-base text-[#1f2e4a]/80 max-w-3xl">
                There is nothing that looks and functions as good as Reckon’s French
                windows, whether they are in rooms overlooking gardens and terraces or
                functioning as the main entrance. These are new-generation uPVC French
            ...
            <div className="mt-8 flex flex-wrap gap-3 items-center">
              ...
              <a href="#contact" className="text-sm font-medium text-[#0e55a1] hover:underline">
                Request a Quote
              </a>
            </div>
          </div>
            ...
            <div className="h-full rounded-2xl bg-white/70 backdrop-blur-sm p-6 border border-white/40 shadow-sm flex flex-col justify-between">
              <div>
                ...
                <p className="mt-2 text-sm text-[#1f2e4a]/80">
                  As one of India’s best manufacturers of French windows and other
                  fenestration products, our uPVC French windows come in a variety of
                  colour options and utilize only the best of materials in their
                  construction.
                </p>
              </div>
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        <Icon
                          className={`w-5 h-5 ${
                            active === idx ? "text-[#0e55a1]" : "text-[#0c4a8e]"
                          }`}
                        />
                      </div>
                      <div>
            ...
            >
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="mt-2 text-sm text-[#1f2e4a]/80">
                    {active === 0 && (
                      <>Premium uPVC French windows with exacting manufacturing tolerances ensuring durability and thermal insulation.</>
                    )}
                    {active === 1 && (
...
export default AboutFrenchWindows;
