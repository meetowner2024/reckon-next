...
const FrenchWindowsFaq = () => {
  ...
  const faqs = [
    { 
      id: 0, 
      category: 'basics', 
      question: 'What is the unique design concept behind uPVC French windows at Reckon.EXT?', 
      answer: 'Our uPVC French windows feature a classic design with a modern touch, providing elegance and functionality for your space.' 
    },
    { 
      id: 1, 
      category: 'features', 
      question: 'What are the key characteristics of uPVC French windows in design and features?', 
      answer: 'Our uPVC French windows are known for their sleek and stylish designs, with options for sliding French windows and casement door definitions to suit your space.' 
    },
    { 
      id: 2, 
      category: 'benefits', 
      question: 'How do uPVC French windows enhance the aesthetics of a room?', 
      answer: 'uPVC French windows create a seamless transition between indoor and outdoor spaces, allowing ample natural light and adding a touch of sophistication to your interior.' 
    },
    { 
      id: 3, 
      category: 'upgrade', 
      question: 'Can I explore French window ideas for my home on the Reckon.EXT website?', 
      answer: 'You can find inspiration and ideas for incorporating uPVC French windows into your home design on our website, helping you make the most of this timeless style.' 
    },
    { 
      id: 4, 
      category: 'features', 
      question: 'What are some modern French window designs that Reckon.EXT offers for Indian homes?', 
      answer: 'We offer a range of modern French window designs that blend contemporary style with traditional elegance, catering to various design preferences.' 
    },
    { 
      id: 5, 
      category: 'upgrade', 
      question: 'Can I convert a French door to a uPVC French window in my home?', 
      answer: 'Yes, we offer solutions to convert French doors into French windows, providing a change in style and functionality.' 
    },
  ];
...
export default FrenchWindowsFaq;