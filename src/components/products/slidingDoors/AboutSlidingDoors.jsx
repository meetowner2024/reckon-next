...
const AboutSlidingDoors = () => {
  ...
  const mainText = `There is nothing that looks and functions as good as Reckon's Sliding Doors, whether they are in rooms overlooking gardens and terraces or functioning as the main entrance. These are new-generation uPVC Sliding Doors designed for larger openings and are adjoined by multiple sashes in a unique mechanism, courtesy of our highly capable team of fenestration experts.`;

  const manufacturerText = `As one of India's best manufacturers of Sliding Doors and other fenestration products, our uPVC Sliding Doors come in a variety of colour options and utilize only the best of materials in their construction. What's more, the highly accurate manufacturing processes ensure that the doors are completely secure and insulated. Enhancing the aesthetic appeal of your home, the uPVC Sliding Doors we offer in India are worth their cost and more.`;
...
export default AboutSlidingDoors;