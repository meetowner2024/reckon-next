  ...
  const faqs = [
    {
      id: 0,
      category: 'benefits',
      question: 'What are the benefits of Reckon.EXT uPVC sliding windows with mosquito mesh?',
      answer: 'Reckon.EXT uPVC sliding windows with mosquito mesh offer superior ventilation and protection against insects. Enjoy fresh air without the nuisance of bugs.'
    },
    {
      id: 1,
      category: 'features',
      question: 'What makes 3-track uPVC sliding windows with mesh a popular choice?',
      answer: '3-track uPVC sliding windows with mesh provide excellent ventilation options, enhanced security, and protection against insects, making them a favoured choice for many homeowners.'
    },
    {
      id: 2,
      category: 'pricing',
      question: 'How does the price of 3-track uPVC sliding windows compare to 2.5-track options?',
      answer: 'The pricing of 3-track uPVC sliding windows may vary depending on your requirements. For accurate pricing, please get in touch with our sales team.'
    },
    {
      id: 3,
      category: 'quote',
      question: 'How can I get a quote for Reckon.EXT uPVC sliding windows?',
      answer: 'For a customized quote for our uPVC sliding windows, including 3 track options, please visit our "Contact Us" page.'
    },
    {
      id: 4,
      category: 'design',
      question: 'Are Reckon.EXT uPVC sliding windows available in white?',
      answer: 'Yes, we offer uPVC sliding windows in a crisp white finish that complements interior and exterior designs.'
    },
    {
      id: 5,
      category: 'features',
      question: 'What are the key features of Reckon.EXT Sliding Windows?',
      answer: 'Reckon.EXT Sliding Windows are crafted for seamless functionality and aesthetic appeal. They feature smooth gliding mechanisms, providing effortless operation.'
    },
  ];
...
export default SlidingWindowFaq;