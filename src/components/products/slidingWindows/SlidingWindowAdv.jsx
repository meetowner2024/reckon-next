...
import { ChevronLeft, ChevronRight, Leaf, Sun, ShieldOff, Zap, Volume2, Shield, Bug, Wrench } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <p className="mt-3 text-gray-600 text-lg font-medium">
            Discover cutting-edge features in a sleek design
          </p>
        </div>
...
export default SlidingWindowAdv;